        ...
        <div style={{
          ...
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            ...
            <h1 style={{
              ...
              Style<span style={{ WebkitTextFillColor: "#60a5fa", backgroundImage: "none" }}>Hub</span>
            </h1>
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              <div style={{ position: "relative" }}>
                <span style={{
                  ...
                  color: focusEmail ? "#60a5fa" : "#475569", transition: "color 0.2s",
                }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M4 4h16v16H4z" /><path d="M4 8h16" /><path d="M8 12h8" />
                  </svg>
                </span>
                <input
                  ...
                  style={{
                    ...
                    border: `1px solid ${focusEmail ? "rgba(59,130,246,0.6)" : "rgba(255,255,255,0.08)"}`,
                    borderRadius: "12px",
                    padding: "14px 16px 14px 44px",
                    color: "#e2e8f0", fontSize: "14px",
                    outline: "none",
                    boxShadow: focusEmail ? "0 0 0 3px rgba(59,130,246,0.15)" : "none",
                    transition: "all 0.2s",
                  }}
                />
              </div>
          ...
          <p style={{ textAlign: "center", marginTop: "24px", color: "#334155", fontSize: "12px" }}>
            © 2026 StyleHub • Secure Control Panel
          </p>
        </div>
      </div>
    </div>
